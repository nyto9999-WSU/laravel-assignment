                    ...
                    <form action="{{ route('user.updateProfile', $user) }}" method="post">
                        ...
                        <div class="row" style="margin: 0">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <input class="form-control" id="phone" name="mobile_number" type="text" value="{{ $user->mobile_number }}">
                            </div>
                            <div class="col-md-12 mt-2">
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <input class="form-control" id="postcode" name="postcode" type="text" value="{{ $user->postcode }}">
                            </div>
                            <div class="col-md-12 mt-2">
