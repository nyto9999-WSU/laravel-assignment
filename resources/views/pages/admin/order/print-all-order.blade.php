...
@section('content')
    ...
    <div class="container" id="my_table">
        <input style="display:block; margin:0 auto;" type="button" class="btn text-white fw-bold" id="blue" onclick="printDiv('my_table')"
        value="Click to Print" />
        @foreach ($jobs as $job)
            @php
                $order = $job->order;
            @endphp
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <h3>Job Worksheet</h3>
                    <table class="table" border="1" style="border-collapse:collapse;" width="90%" cellpadding="3"
                        cellspacing="3">
